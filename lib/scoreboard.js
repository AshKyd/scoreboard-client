(function() {
    ...
    this.Scoreboard = function(o) {
        o = {
            webStorageKey: o.webStorageKey || 'scoreboard',
            storageEngine: o.storageEngine || 'webstorage',
            classes: o.classes || [
                'regular'
            ],
            fields: o.fields || {
    ...
    this.Scoreboard.prototype = {
        ...
        initialise: function() {
            ...
            for (var i = 0; i < _this.options.classes.length; i++) {
                var thisClass = {};
                for(fieldName in this.options.fields){
                    thisClass[fieldName] = _this.makeField(this.options.fields[fieldName]);
                }
        ...
        updateFields: function(classname, values) {
            ...
            for(valName in values){
                _this.updateField(classname, valName, values[valName]);
            }
